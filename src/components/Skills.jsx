            ...
            >
                <div className="text-center mb-16 lg:mb-24">
                    <div className="flex items-center justify-center gap-4 mb-6 text-center">
                        ...
                        <span className="text-primary font-mono text-lg font-bold tracking-[0.3em] uppercase">My Stack</span>
                        <span className="w-12 h-px bg-primary"></span>
                    </div>
                    <h2 className="text-5xl md:text-7xl font-display font-black text-white leading-tight mb-8">
                        TOOLS OF<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-primary bg-300% animate-gradient">THE TRADE.</span>
                    </h2>
                    <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light leading-relaxed">
                        I leverage a modern ecosystem of tools and frameworks to build scalable, high-performance web applications.
                    </p>
                </div>
